...
router.post('/get-location-by-coords', currentUser,
requireAuth,
[
...
//    var locationJoined = locationArray.join('');
   ...
   // console.log(longitude);
    ...
    var requesturl = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+latLong+'&sensor=true&key=AIzaSyCQ0nnEa6e-uoCqZz22D8qd46HIBBOGm3g' ;
    ...
    const getAddress = async () => {
        try {
          ...
          console.error(error);
          //return error
          throw new BadRequestError('Unable to get location from coordinates given. (Google API).');
        }
      }
